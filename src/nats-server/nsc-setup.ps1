...
.\nsc.exe generate creds --account peanuts --name checker --output-file ./checker.creds
.\nsc.exe generate creds --account peanuts --name conveyor --output-file ./conveyor.creds
.\nsc.exe generate creds --account peanuts --name dashboard --output-file ./dashboard.creds
